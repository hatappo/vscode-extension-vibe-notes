...
export class CommentDecorationProvider {
  ...
  constructor(private memoHandler: MemoFileHandler, private workspaceFolder: vscode.WorkspaceFolder) {
    ...
    this.decorationType = vscode.window.createTextEditorDecorationType({
      gutterIconPath: vscode.Uri.parse('data:image/svg+xml;utf8,<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="6" fill="%234285f4"/><text x="8" y="11" text-anchor="middle" fill="white" font-size="10" font-family="Arial">C</text></svg>'),
