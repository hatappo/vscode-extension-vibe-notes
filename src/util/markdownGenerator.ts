 ...
 */
export async function generateMarkdownFileContent(notes: Note[], workspaceFolder: vscode.WorkspaceFolder): Promise<string> {
 ...
 */
export async function generateEnhancedMarkdown(notes: Note[], workspaceFolder: vscode.WorkspaceFolder, includeCode: boolean = true): Promise<string> {
	if (notes.length === 0) {
